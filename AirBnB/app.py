...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/npulagam/AirBnB_Test/master/AirBnB/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -49431.908808923305
exported_pipeline = DecisionTreeRegressor(max_depth=5, min_samples_leaf=4, min_samples_split=8)
...
encoder_location = 'https://github.com/npulagam/AirBnB_Test/blob/master/AirBnB/encoder.pkl?raw=true'
